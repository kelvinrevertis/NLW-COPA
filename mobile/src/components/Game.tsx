...
interface Props {
  ...
  setSecondTeamsPoint: (value: string) => void;
};

export function Game({ data, setFirstTeamPoints, setSecondTeamsPoint, onGuessConfirm }: Props) {
    ...
    >
      ...
      <HStack mt={4} w="full" justifyContent="space-between" alignItems="center">
        ...
        <Team
          ...
          position="left"
          onChangeText={setSecondTeamsPoint}
        />
      </HStack>
