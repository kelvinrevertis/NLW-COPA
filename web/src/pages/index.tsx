    ...
    <div className='max-w-[1124px] h-screen mx-auto grid grid-cols-2 items-center gap-28'>
      <main>
        ...
        <form onSubmit={createPool} className='mt-10 flex gap-2'>
          ...
          <button className='bg-yellow-500 px-6 py-4 rounded text-gray-900 font-bold font-sm uppercase hover:bg-yellow-700' type='submit'>Criar meu bolão</button>
        </form>
      ...
      <Image src={appPreviewImg} alt="Celulares preview" quality={100} />
    </div >
